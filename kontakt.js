$(document).ready(function () {
    $("#contact-form").on("submit", function (e) {
        ...
        // Ekzekutojmë kërkesën profesionale AJAX
        $.ajax({
            url: $form.attr("action"),
            method: "POST",
            data: $form.serialize(), // Paketon fushat automatikisht në mënyrë të sigurt
            dataType: "json",
            success: function () {
                ...
                $form[0].reset(); // Pastrojmë fushat e formularit
            },
            error: function () {
                // Nëse ndodh ndonjë gabim i papritur
                $status.html(
            ...
            complete: function () {
                ...
                // Heqim njoftimin automatikisht pas 6 sekondave nëse përdoruesi nuk e mbyll vetë
                setTimeout(function () {
                    $status.empty();
                }, 6000);
            }
